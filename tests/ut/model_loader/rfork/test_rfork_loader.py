...
def test_rfork_seed_key_isolated_by_ep_rank():
    ...
    assert get_local_seed_key(**common_config, ep_rank=0) == "/models/dsv4$decode$kv_consumer$0$0$0"
    assert get_local_seed_key(**common_config, ep_rank=1) == "/models/dsv4$decode$kv_consumer$0$0$1"
...
def test_rfork_seed_key_isolated_by_pp_rank():
    ...
    assert get_local_seed_key(**common_config, pp_rank=0) == "/models/dsv4$decode$kv_consumer$0$0$0$0"
    assert get_local_seed_key(**common_config, pp_rank=1) == "/models/dsv4$decode$kv_consumer$0$1$0$0"
...
def test_rfork_draft_seed_key_isolated_by_ep_rank():
    assert (
        ...
        == "/models/dsv4$decode$kv_consumer$0$0$5$draft"
    )
...
def test_rfork_detects_dynamic_eplb_config():
    ...
    assert not _is_dynamic_eplb_enabled(SimpleNamespace(additional_config={"eplb_config": {}}))
    assert not _is_dynamic_eplb_enabled(SimpleNamespace(additional_config=None))
